...
const envSchema = z
  .object({
    ...
    PAYMOB_API_KEY: optionalNonEmptyString,
    PAYMOB_HMAC_SECRET: z.string().min(1),
    PAYMOB_PUBLIC_KEY: z.string().min(1),
    PAYMOB_SECRET_KEY: z.string().min(1),
    PAYMOB_CARD_INTEGRATION_ID: optionalNonEmptyString,
    PAYMOB_WALLET_INTEGRATION_ID: optionalNonEmptyString,
    PAYMOB_APPLE_PAY_INTEGRATION_ID: optionalNonEmptyString,
